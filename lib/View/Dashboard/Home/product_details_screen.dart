...
import '../../../Models/HomeModels/get_product_byId_model.dart' as model;
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    super.initState();
    kCategoryController
        .getProductByIdAPICall({"user_id": kAuthenticationController.userId}, widget.productId, () {
                                          ...
                                          child: Column(
                                            children: [
                                              StatefulBuilder(builder: (context, setState) {
                                                return appBarButton(
                                                    image: iconsLike,
                                                    iconColor: kCategoryController
                                                                .getProductByIdModel.value.like ==
                                                            0
                                                        ? black
                                                        : red,
                                                    callBack: () {
                                                      ...
                                                      if (kCategoryController
                                                          ...
                                                          0) {
                                                        kCategoryController
                                                            .getProductByIdModel.value.like = 1;
                                                        kHomeController.addToWishlistAPICall(
                                                            params, () {});
                                                      } else {
                                                        kCategoryController
                                                            .getProductByIdModel.value.like = 0;
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                  ...
                                                  children: kCategoryController
                                                      ...
                                                      .map(
                                                    (e) {
                                                      return commonProductDetailsRow(
                                                          title: e.name ?? '',
                                        ...
                                        height20,
                                        if (kCategoryController
                                                    .getProductByIdModel.value.relatedProducts !=
                                                null &&
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              GridView.builder(
                                                shrinkWrap: true,
                                                itemCount: kCategoryController.getProductByIdModel
  ...
  Widget commonProductDetailsRow({required String title, required String subTitle, int? index}) {
    return Column(
      children: [
        ...
        // if ((kCategoryController.getProductByIdModel.value.data!.attributes.length - 1) != index)
        const Divider(),
      ],
    );
  }
