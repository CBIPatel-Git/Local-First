                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              height20,
                              commonProductDetailsRow(
                                  title: 'Model Name', subTitle: 'Galaxy M14 5G'),
                              commonProductDetailsRow(title: 'Color', subTitle: 'Icy Silver'),
                              commonProductDetailsRow(
                                  title: 'Browse Type', subTitle: 'Smartphones'),
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return ClipRRect(
                                        ...
                                        child:
                                            Image(image: imagesReviewImage).marginOnly(right: 12));
                                  },
                                ),
                              ),
                              height10,
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: Obx(() {
                                            return appBarButton(
                                                image: iconsLike,
                                                iconColor: likedSimilarProduct.contains(index)
                                                    ? red
                                                    : black,
                                                callBack: () {
