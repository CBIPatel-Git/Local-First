...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void getHomeData() {
    if (kHomeController.dashboardModel.value.data == null) {
      ...
      kHomeController.getDashboardAPICall(params, () {
        if (kHomeController.dashboardModel.value.data != null) {
          // dashboardData.value = kHomeController.dashboardModel.value.data!;
  ...
  Widget build(BuildContext context) {
    return commonStructure(
        ...
        child: SafeArea(
          child: StreamBuilder(
              stream: kHomeController.dashboardModel.stream,
                    ...
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    if (kHomeController.dashboardModel.value.data != null &&
                                        kHomeController
                                            .dashboardModel.value.data!.productsCategory.isNotEmpty)
                                      Column(
                                        children: [
                                          customHeight(12),
                                          commonTitleRow(
                              ...
                              if (kHomeController.dashboardModel.value.data != null &&
                                ...
                                ListView.builder(
                                  itemCount: kHomeController
                                          ...
                                          3
                                      ? 3
                                      : kHomeController.dashboardModel.value.data!.nearStore.length,
                                  shrinkWrap: true,
                          ...
                          if (kHomeController.dashboardModel.value.data != null &&
                              kHomeController.dashboardModel.value.data!.todayOffer.isNotEmpty)
                            Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 16),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                      ...
                                      return InkWell(
                                        onTap: () {
                                          Get.to(() => ProductDetailsScreen(
                                                productId: kHomeController.dashboardModel.value
                                                        .data!.todayOffer[index].id ??
                                                    0,
                                              ));
                                        },
                                        child: Container(
                                                    ...
                                                    child: StatefulBuilder(
                                                      ...
                                                      return InkWell(
                                                        onTap: () {
                                                          ...
                                                          if (kHomeController.dashboardModel.value
                                                                  .data!.todayOffer[index].like ==
                                                              0) {
                                                            kHomeController.dashboardModel.value
                                                                .data!.todayOffer[index].like = 1;
                                                            kHomeController.addToWishlistAPICall(
                                                                params, () {});
                                                          } else {
                                                            kHomeController.dashboardModel.value
                                                                .data!.todayOffer[index].like = 0;
