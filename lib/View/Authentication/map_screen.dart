        ...
        children: [
          ...
          Padding(
            ...
            child: commonTextField(
                hintText: widget.isManually ? widget.address ?? 'Search' : "Search",
                textEditingController: searchController,
                ...
                child: commonFilledButton(
                    onTap: () {
                      setSelectedLocationLat(
                          lat: (widget.isManually ? currentPosition?.latitude : widget.lat) ?? 0.0);
                      setSelectedLocationLng(
                          lng: (widget.isManually ? currentPosition?.longitude : widget.long) ??
                              0.0);
                      Map<String, dynamic> params = {
                        "user_id": kAuthenticationController.userId,
                        "latitude": widget.isManually ? currentPosition?.latitude : widget.lat,
                        "longitude": widget.isManually ? currentPosition?.longitude : widget.long,
                        "radius": 3
                      };
