...
class Data {
  Data({
    ...
    required this.nearStore,
    required this.todayOffer,
  });

  final List<ProductsCategory> productsCategory;
  final List<NearStore> nearStore;
  final List<TodayOffer> todayOffer;

  factory Data.fromJson(Map<String, dynamic> json){
    return Data(
      productsCategory: json["products_category"] == null ? [] : List<ProductsCategory>.from(json["products_category"]!.map((x) => ProductsCategory.fromJson(x))),
      nearStore: json["near_store"] == null ? [] : List<NearStore>.from(json["near_store"]!.map((x) => NearStore.fromJson(x))),
      todayOffer: json["todayOffer"] == null ? [] : List<TodayOffer>.from(json["todayOffer"]!.map((x) => TodayOffer.fromJson(x))),
    );
  }

  Map<String, dynamic> toJson() => {
    "products_category": productsCategory.map((x) => x.toJson()).toList(),
    "near_store": nearStore.map((x) => x.toJson()).toList(),
...
class Details {
  ...
  final DetailsMembershipDetails? membershipDetails;
  ...
  factory Details.fromJson(Map<String, dynamic> json){
    return Details(
      ...
      membershipDetails: json["membership_details"] == null ? null : DetailsMembershipDetails.fromJson(json["membership_details"]),
...
class DetailsMembershipDetails {
  DetailsMembershipDetails({
    required this.membershipTitle,
    required this.membershipId,
    required this.membershipNextPayment,
    required this.membershipExpiryOn,
  });
  ...
  factory DetailsMembershipDetails.fromJson(Map<String, dynamic> json){
    return DetailsMembershipDetails(
      membershipTitle: json["membership_title"],
      membershipId: json["membership_id"],
      membershipNextPayment: json["membership_next_payment"],
      membershipExpiryOn: json["membership_expiry_on"],
    );
  }
...
class ProductsCategory {
  ...
  final ProductsCategoryImage? image;
  final num? menuOrder;
  final num? count;
  final Links? links;
  ...
  factory ProductsCategory.fromJson(Map<String, dynamic> json){
    return ProductsCategory(
      ...
      image: json["image"] == null ? null : ProductsCategoryImage.fromJson(json["image"]),
...
class ProductsCategoryImage {
  ...
  factory ProductsCategoryImage.fromJson(Map<String, dynamic> json){
    return ProductsCategoryImage(
      id: json["id"],
...
class ValueClass {
  ...
  final String? fbtDiscountSpend;
  final num? fbtDiscountProductsCount;

  factory ValueClass.fromJson(Map<String, dynamic> json){
    return ValueClass(
      policyTabTitle: json["policy_tab_title"],
      shippingPolicy: json["shipping_policy"],
      refundPolicy: json["refund_policy"],
      cancellationPolicy: json["cancellation_policy"],
      fbtProducts: json["fbt_products"] == null ? [] : List<dynamic>.from(json["fbt_products"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    "policy_tab_title": policyTabTitle,
    "shipping_policy": shippingPolicy,
    "refund_policy": refundPolicy,
    "cancellation_policy": cancellationPolicy,
...
class Store {
  ...
  final String? emailVerified;
  final List<VendorAdditionalInfo> vendorAdditionalInfo;
  final StoreMembershipDetails? membershipDetails;
  final String? vendorDescription;
  final WcfmProductPolicyData? vendorPolicies;
  final StoreTabHeadings? storeTabHeadings;
  ...
  factory Store.fromJson(Map<String, dynamic> json){
    return Store(
      ...
      emailVerified: json["email_verified"],
      vendorAdditionalInfo: json["vendor_additional_info"] == null ? [] : List<VendorAdditionalInfo>.from(json["vendor_additional_info"]!.map((x) => VendorAdditionalInfo.fromJson(x))),
      membershipDetails: json["membership_details"] == null ? null : StoreMembershipDetails.fromJson(json["membership_details"]),
      vendorDescription: json["vendor_description"],
      vendorPolicies: json["vendor_policies"] == null ? null : WcfmProductPolicyData.fromJson(json["vendor_policies"]),
      storeTabHeadings: json["store_tab_headings"] == null ? null : StoreTabHeadings.fromJson(json["store_tab_headings"]),
    );
...
class StoreMembershipDetails {
  ...
  factory StoreMembershipDetails.fromJson(Map<String, dynamic> json){
