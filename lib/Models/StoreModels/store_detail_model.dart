...
class Child {
  ...
  factory Child.fromJson(Map<String, dynamic> json){
    return Child(
      ...
      count: json["count"],
      links: json["_links"] == null ? null : ChildLinks.fromJson(json["_links"]),
    );
  }
...
class Parent {
  ...
  factory Parent.fromJson(Map<String, dynamic> json){
    return Parent(
      ...
      description: json["description"],
      display: json["display"],
      image: json["image"] == null ? null : ParentImage.fromJson(json["image"]),
      menuOrder: json["menu_order"],
      count: json["count"],
